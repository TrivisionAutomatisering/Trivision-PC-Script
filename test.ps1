...
$Office365 = {
    ...
    Expand-Archive C:\Temp\Office365.zip -DestinationPath H:\Temp -Force
    Remove-Item "C:\Temp" -Recurse
    Start-Process -Path H:\Temp\setup.exe -ArgumentList "/configure "H:\Temp\Office nl-NL x64.xml""
}
